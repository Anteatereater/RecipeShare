    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ComponentRecipe", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ComponentRecipe_Components_ComponentId",
                        column: x => x.ComponentId,
                        principalTable: "Components",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ComponentRecipe_Recipes_RecipeId",
                        column: x => x.RecipeId,
                        principalTable: "Recipes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ComponentRecipe_ComponentId",
                table: "ComponentRecipe",
                column: "ComponentId");

            migrationBuilder.CreateIndex(
                name: "IX_ComponentRecipe_RecipeId",
                table: "ComponentRecipe",
                column: "RecipeId");
